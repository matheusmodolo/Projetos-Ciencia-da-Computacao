...
public class InstructionDEFINT extends InstructionOneArg {
    ...
    /**
     * Must be overridden for pseudo opcodes since the opcode doesn't actually
    ...
    /**
     * Abstract method -- must be overridden even though it plays no significant
     * role for pseudo opcodes.
     */
    @Override
