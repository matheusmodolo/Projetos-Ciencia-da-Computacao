...
public class BitUtil {
    ...
    /**
     * Returns a binary string representation of the least significant (right
     * most) bits for the specified int.
     */
    ...
    /**
     * Returns a binary string representation of the least significant (right
     * mode) bits for the specified short.
     */
    ...
    /**
     * Returns a binary string representation of the least significant (right
     * mode) bits for the specified byte.
     */
    ...
    /**
     * Returns the n least significant (rightmost) bits in the specified value
     * as a signed (2s complement) integer.
     */
    ...
    /**
     * Returns the n least significant (rightmost) bits in the specified value
     * as an unsigned integer; i.e., the most significant bit is not interpreted
     * as a sign bit.
     */
