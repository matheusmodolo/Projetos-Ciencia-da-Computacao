...
public class Scanner {
        ...
        try {
            ...
            if (source.getChar() == Source.EOF) {
                ...
                switch ((char) source.getChar()) {
                    ...
                    // que o comentário é irrelevante e depois de escaneado,
                    // deve ser descartado.
                    ...
                    case '<':
                        //avança para ver o prox charactere
                        source.advance();
    ...
    private String scanIdentifier() throws IOException {
        ...
        // <editor-fold defaultstate="collapsed" desc="Implementação">
        // sua implementação aqui
        assert Character.isLetter((char) source.getChar()) || Character.isDigit((char) source.getChar()) :
    ...
    private Symbol getIdentifierSymbol(String idString) {
        ...
        switch (idString) {
            case "Boolean":
                symbol = Symbol.BooleanRW;
                break;
            case "Char":
                symbol = Symbol.CharRW;
                break;
            case "Integer":
                symbol = Symbol.IntegerRW;
                break;
            case "String":
                symbol = Symbol.StringRW;
                break;
            case "and":
                symbol = Symbol.andRW;
                break;
            case "array":
                symbol = Symbol.arrayRW;
                break;
            case "begin":
                symbol = Symbol.beginRW;
                break;
            case "class":
                symbol = Symbol.classRW;
                break;
            case "const":
                symbol = Symbol.constRW;
                break;
            case "declare":
                symbol = Symbol.declareRW;
                break;
            case "else":
                symbol = Symbol.elseRW;
                break;
            case "elsif":
                symbol = Symbol.elsifRW;
                break;
            case "end":
                symbol = Symbol.endRW;
                break;
            case "exit":
                symbol = Symbol.exitRW;
                break;
            case "false":
                symbol = Symbol.falseRW;
                break;
            case "for":
                symbol = Symbol.forRW;
                break;
            case "function":
                symbol = Symbol.functionRW;
                break;
            case "if":
                symbol = Symbol.ifRW;
                break;
            ...
            case "or":
                ...
                break;
            case "private":
                symbol = Symbol.privateRW;
                break;
            case "procedure":
                symbol = Symbol.procedureRW;
                break;
            case "program":
                symbol = Symbol.programRW;
                break;
            case "protected":
                symbol = Symbol.protectedRW;
                break;
            case "public":
                symbol = Symbol.publicRW;
                break;
            case "read":
                symbol = Symbol.readRW;
                break;
            case "readln":
                symbol = Symbol.readRW;
                break;
            case "return":
                symbol = Symbol.returnRW;
                break;
            case "then":
                symbol = Symbol.thenRW;
                break;
            case "true":
                symbol = Symbol.trueRW;
                break;
            case "type":
                symbol = Symbol.typeRW;
                break;
            case "var":
                symbol = Symbol.varRW;
                break;
            case "when":
                symbol = Symbol.whenRW;
                break;
            case "while":
                symbol = Symbol.whileRW;
                break;
            case "write":
                symbol = Symbol.writeRW;
                break;
            case "writeln":
                symbol = Symbol.writelnRW;
                break;
            default:
