...
public class Scanner {
    ...
    /**
     * Scans characters in the source file for an escaped character; i.e., a
     * character preceded by a backslash. This method handles escape characters
     * \b, \t, \n, \f, \r, \", \', and \\. If the character following a
     * backslash is anything other than one of these characters, then an
    ...
    private char scanEscapedChar() throws ScannerException, IOException {
        ...
        switch ( c ) {
            ...
            case '\\':
                return '\\';   // backslash
            default:
                throw new ScannerException( backslashPosition, "Illegal escape character." );
        }
    }

    /**
     * Returns the symbol associated with an identifier (Symbol.ADD, Symbol.AND,
     * Symbol.identifier, etc.)
     */
