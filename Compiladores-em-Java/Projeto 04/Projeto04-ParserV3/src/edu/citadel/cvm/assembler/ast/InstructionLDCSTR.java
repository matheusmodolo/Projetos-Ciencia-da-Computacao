 ...
 * instruction LDCSTR. <br>
 *
 * Note: Only one argument (the string literal) is specified for this
 * instruction in assembly language, but two args are generated for the CVM
 * machine code.
 */
