...
/**
 * This class encapsulates the source file reader. It maintains the position of
 * each character in the source file.
 */
public final class Source {
    ...
    /**
     * Returns the current character (as an int) in the source file. Returns EOF
    ...
    /**
     * Returns the position (line number, char number) of the current character
     * in the source file.
     */
