...
public class ErrorHandler {
    ...
    protected ErrorHandler() {
        ...
        err = new PrintWriter( System.out, true, StandardCharsets.UTF_8 );
    }
    ...
    /**
     * Sets the PrintWriter to be used for all error messages written by the
     * ErrorHandler. (Defaults to System.err if not set.)
     */
    ...
    /**
     * Reports the error. Stops compilation if the maximum number of errors have
     * been reported.
     */
    ...
    /**
     * Reinicia o contador de erros, permitindo a execução dos testes de 
     * unidade que não podem manter o contexto dos erros nos testes prévios.
     * 
