 ...
 * Type sizes are initialized to values appropriate for the CPRL virtual
 * machine.
 */
public class Type {
    ...
    /**
     * Construct a new Type with the specified type name. Size is initially set
     * to 0.
     */
    ...
    /**
     * Returns the number of machine addressable units (e.g., bytes or words)
     * for this type.
     */
    public int getSize() {
        return size;
    ...
    /**
     * Sets the number of machine addressable units (e.g., bytes or words) for
     * this type.
     */
    ...
    /**
     * Returns true if and only if this type is a scalar type. The scalar types
     * in CPRL are Integer, Boolean, and Char.
     */
    ...
    /**
     * Returns the type of a literal symbol. For example, if the symbol is an
     * intLiteral, then Type.Integer is returned.
     *
