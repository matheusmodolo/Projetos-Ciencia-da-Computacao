...
/**
 * Instantiates the generic class AbstractToken for CVM assembly language
 * symbols.
 */
public final class Token extends AbstractToken<Symbol> {
    ...
    /**
     * Constructs a new Token with the specified symbol. Position and text are
     * initialized to null This constructor is useful when replacing
     * instructions during optimization.
     */
    ...
    /**
     * Constructs a new Token with the specified symbol and text. Position is
     * initialized to null. This constructor is useful when replacing
     * instructions during optimization.
     */
