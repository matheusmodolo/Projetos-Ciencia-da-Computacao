...
public abstract class CompilerException extends Exception {
    ...
    /**
     * Construct an exception with information about the nature and position of
     * the error.
     *
     * @param errorType the name of compilation phase in which the error was
     * detected.
     * @param position the position in the source file where the error was
     * detected.
    ...
    /**
     * Construct an exception with information about the nature of the error but
     * not its position.
     *
     * @param errorType the name of compilation phase in which the error was
     * detected.
